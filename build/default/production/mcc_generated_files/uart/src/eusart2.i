...
# 46 "mcc_generated_files/uart/src/../../system/../uart/eusart1.h"
# 1 "mcc_generated_files/uart/src/../../system/system.h" 1
...
static volatile uint8_t eusart2RxBuffer[(128U)];
static volatile eusart2_status_t eusart2RxStatusBuffer[(128U)];
...
size_t EUSART2_ErrorGet(void)
{
    eusart2RxLastError.status = eusart2RxStatusBuffer[(eusart2RxTail + 1U) & ((128U) - 1U)].status;
...
uint8_t EUSART2_Read(void)
{
    ...
    tempRxTail = (eusart2RxTail + 1U) & ((128U) - 1U);
...
void EUSART2_ReceiveISR(void)
{
 ...
 uint8_t tempRxHead;
    ...
    tempRxHead = (eusart2RxHead + 1U) & ((128U) - 1U);
