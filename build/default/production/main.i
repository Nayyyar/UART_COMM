...
# 266 "./mcc_generated_files/system/../uart/eusart1.h"
_Bool EUSART1_IsRxReady(void);
# 275 "./mcc_generated_files/system/../uart/eusart1.h"
_Bool EUSART1_IsTxReady(void);
# 284 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 302 "./mcc_generated_files/system/../uart/eusart1.h"
uint8_t EUSART1_Read(void);
# 312 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 337 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 362 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 46 "./mcc_generated_files/system/../uart/eusart2.h"
# 1 "./mcc_generated_files/system/../uart/../system/system.h" 1
# 46 "./mcc_generated_files/system/../uart/eusart2.h" 2
# 92 "./mcc_generated_files/system/../uart/eusart2.h"
typedef union {
    struct {
        uint8_t perr : 1;
        uint8_t ferr : 1;
...
# 110 "./mcc_generated_files/system/../uart/eusart2.h"
extern const uart_drv_interface_t UART2;
# 119 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 152 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 169 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 266 "./mcc_generated_files/system/../uart/eusart2.h"
_Bool EUSART2_IsRxReady(void);
# 275 "./mcc_generated_files/system/../uart/eusart2.h"
_Bool EUSART2_IsTxReady(void);
# 284 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 302 "./mcc_generated_files/system/../uart/eusart2.h"
uint8_t EUSART2_Read(void);
# 312 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 337 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 362 "./mcc_generated_files/system/../uart/eusart2.h"
...
_Bool isRadioDataRecieved = 0;
_Bool isDebugDataReceived = 0;
...
void ProcessDebugDataUART2(void) {
    ...
    while (EUSART2_IsRxReady()) {
        uint8_t newChar = EUSART2_Read();
        if (newChar != ((uint8_t)'\r') && newChar != ((uint8_t)'\n')) {
            if (rxIndex_UART2 < sizeof (debug_Buffer) - 1) {
        ...
        if (newChar == ((uint8_t)'\n') || newChar == ((uint8_t)'\r')) {
            debug_Buffer[rxIndex_UART2] = '\0';
            char Debug_Buff[100];
            sprintf(Debug_Buff, "%s", debug_Buffer);
            memcpy(debug_Msg, debug_Buffer, sizeof (Debug_Buff));
            memset(debug_Buffer, '\0', sizeof (debug_Buffer));
            memset(Debug_Buff, '\0', sizeof (Debug_Buff));
            UART2_sendString("Got: ");
            UART2_sendString(debug_Msg);
            strcat(debug_Msg, "\r");
...
void ProcessRadioDataUART1(void) {
    while (EUSART1_IsRxReady()) {
        ...
        uint8_t newChar = EUSART1_Read();

        if (newChar != ((uint8_t)'\r') && newChar != ((uint8_t)'\n')) {
            if (rxIndex_Radio < sizeof (radio_Buffer) - 1) {
        ...
        if (newChar == ((uint8_t)'\n')) {
            toggleLED(50);
            radio_Buffer[rxIndex_Radio] = '\0';
            char Radio_Buff[100];
            memcpy(radio_Msg, radio_Buffer, sizeof (radio_Buffer));
            memset(radio_Buffer, '\0', sizeof (radio_Buffer));
            memset(Radio_Buff, '\0', sizeof (Radio_Buff));

            UART2_sendString(radio_Msg);
            memset(radio_Msg, '\0', sizeof (radio_Msg));
            rxIndex_Radio = 0;
            UART2_sendString("\n");
        }
...
void UART1_Check(void) {
    isRadioDataRecieved = 1;
}

void UART2_Check(void) {
    isDebugDataReceived = 1;
}
